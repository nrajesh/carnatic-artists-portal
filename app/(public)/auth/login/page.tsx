...
import { emailFieldRestrictedHandlers } from '@/lib/restricted-input-handlers';
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} noValidate>
              {formatNote.message ? (
                <FormFieldNotice tone="warning" className="mb-4">
                  {formatNote.message}
                </FormFieldNotice>
              ) : null}
              <div className="mb-4">
              ...
              {status === 'error' ? (
                <FormFieldNotice tone="error" className="mb-4">
                  {errorMessage}
                </FormFieldNotice>
              ) : null}
