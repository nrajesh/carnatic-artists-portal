...
<p>Having relocated to The Netherlands in 2018, Lakshmi has been instrumental in building the Indian classical music community in Amsterdam. She performs regularly at the Muziekgebouw aan 't IJ and has collaborated with leading instrumentalists across Europe. She also runs a weekly vocal class for children of the Indian diaspora in Amsterdam.</p>
<p>In 2023, she released her debut album <em>Nada Sudha</em> - a collection of compositions by the Trinity composers, recorded live at the Concertgebouw. The album received widespread acclaim from listeners worldwide.</p>`,
    availabilityDates: [
...
<p>Since moving to The Netherlands in 2015, Ravi has been a cornerstone of the Dutch Indian classical scene, performing at major festivals including the North Sea Jazz Festival and the Amsterdam World Music Festival. He teaches at the Rotterdam Conservatory and has trained over 50 students in the Netherlands.</p>
<p>Ravi is also a composer, having written several original compositions in the South Indian classical tradition that blend classical structures with contemporary sensibilities. His composition <em>Neeraja</em> in raga Charukesi has been widely performed by artists across Europe.</p>`,
    availabilityDates: [
...
<p>Since relocating to Rotterdam in 2020, Priya has become one of the most active performers in the Dutch Indian classical community. She performs regularly at the De Doelen concert hall and has been a featured artist at the Rotterdam World Music Festival for three consecutive years.</p>
<p>Priya is also an active music teacher, running a vocal school in Rotterdam with over 30 students. She is passionate about making classical repertoire accessible to the next generation and regularly performs at schools and community centres across South Holland.</p>`,
    availabilityDates: [
...
<p>Based in Eindhoven since 2021, Karthik has been active in the Dutch music scene, performing at festivals and collaborating with both Indian classical and Western musicians. He recently performed at the STRP Festival in Eindhoven, where his ghatam playing captivated an audience of over 2,000 people.</p>`,
    availabilityDates: [
...
<p>The combination of violin and morsing is unusual in the South Indian classical tradition, and Vijay's mastery of both instruments gives him a unique perspective on classical repertoire. He is able to approach a composition from both a melodic and a rhythmic angle simultaneously, making him an extraordinarily versatile collaborator.</p>
...
<p>Based in Enschede since 2024, Vijay is one of the newer members of the Dutch Indian classical community but has already made a significant impact with his performances and his willingness to collaborate across musical traditions.</p>`,
    availabilityDates: [
...
<p>She is particularly known for her renditions of compositions by women composers in the South Indian classical repertoire - a body of work that has been historically underrepresented in concert settings. Her project <em>Stree Nada</em> (Women's Sound) has brought renewed attention to the contributions of female composers to the classical canon.</p>
<p>Having relocated to Arnhem in early 2025, Nithya is one of the newest members of the Dutch Indian classical community. She is already active in organising concerts and workshops, and her energy and enthusiasm are a welcome addition to the community.</p>`,
    availabilityDates: [
