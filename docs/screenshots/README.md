...
| `about-colour-examples.png`         | Section 1 illustrative 2- and 3-speciality cards                     | `/docs` - scroll to colour theming          |
| `about-analytics-section.png`       | Section 10 PostHog / privacy summary                                 | `/docs` - scroll to analytics               |
